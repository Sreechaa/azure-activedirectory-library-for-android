...
public class BrokerProxyTests extends AndroidTestCase {
    ...
    public void testHasAccount() throws IllegalArgumentException, ClassNotFoundException,
        ...
        // action
        Method m = ReflectionUtils.getTestMethod(brokerProxy, "hasAccount", String.class);
    ...
    private void setProxyWithMocks(Object brokerProxy, AccountManager mockAcctManager)
    ...
    private void prepareProxyForTest(Object brokerProxy, String authenticatorType,
            ...
            boolean permissionStatus) throws NoSuchFieldException, IllegalAccessException,
            NameNotFoundException {
        AccountManager mockAcctManager = mock(AccountManager.class);
        AuthenticatorDescription[] descriptions = getAuthenticator(authenticatorType, brokerPackage);
